  ...
  return (
    <main>
      <section className={css.section}>
        <div className={`${css.page_container} ${css.contacts}`}>
          <h1 className={css.contacts_title}>
            Лідер міжнародних рефрижераторних перевезень
          </h1>

          <p className={css.contacts_about}>
            Багаторічний досвід роботи і незмінна якість наших послуг дозволяє
            нам утримувати позицію лідера галузі рефрижераторних перевезень та
          ...
          <ul>
            ...
            <li className={css.list_item}>
              Міжнародні та внутрішні автомобільні перевезення небезпечних
              вантажів
            </li>
